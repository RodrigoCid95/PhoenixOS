import { ITaskManager, AddTaskOptions, ITask, TaskManagerEvent, TaskManagerEventCallback, IEmitters, IEmitter } from "phoenix-builder"
...
export class TaskManager implements ITaskManager {
  ...
  add<T>({ title, description, icon, el }: AddTaskOptions): ITask<T> {
