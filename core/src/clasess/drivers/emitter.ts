import { CallbackEmitter, EmitterDriver, EmittersDriver } from './../../../types/drivers/emitter'

type CallbackEmitterList = {
  [k: string] : CallbackEmitter<any>
}
export class Emitter implements EmitterDriver {
...
export class Emitters implements EmittersDriver {
  #EMITTERS: Map<string, EmitterDriver> = new Map()
