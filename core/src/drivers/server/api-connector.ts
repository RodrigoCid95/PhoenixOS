import { IAPIConnector, CreateAPIConnectorOpts, IHeaders, UploadArgs, ICipher } from 'phoenix-builder'
...
export class APIConnector implements IAPIConnector {
  ...
  #endpoint: string
  #keyCipher!: CryptoKey
  constructor(private opts: CreateAPIConnectorOpts, private cipher?: ICipher) {
